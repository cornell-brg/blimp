...
`ifndef HW_FETCH_FETCHUNITVARIANTS_FETCHUNITL4_V
`define HW_FETCH_FETCHUNITVARIANTS_FETCHUNITL4_V

`include "hw/common/Fifo.v"
`include "hw/fetch/SeqNumGenL4.v"
...
`endif // HW_FETCH_FETCHUNITVARIANTS_FETCHUNITL4_V
