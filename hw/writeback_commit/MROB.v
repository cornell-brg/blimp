...
module MROB #(
  ...
  input  logic [p_entry_bits-1:0] ins_idx [p_depth],
  input  logic [p_msg_bits-1:0]   ins_msg [p_depth],
  input  logic                    ins_en  [p_depth],
  ...
  output logic [p_entry_bits-1:0] deq_idx [p_depth],
  output logic [p_msg_bits-1:0]   deq_msg [p_depth],
  input  logic                    deq_en  [p_depth],
  ...
  assign avail_slots = p_depth - deq_ptr + 1;
