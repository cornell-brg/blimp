//========================================================================
// DecodeIssueUnitL7_test.v
//========================================================================
// A testbench for our decode-issue unit with WAW stalling

`include "asm/assemble.v"
`include "defs/UArch.v"
`include "hw/decode_issue/decode_issue_unit_variants/DecodeIssueUnitL7.v"
...
//========================================================================
// DecodeIssueUnitL7TestSuite
//========================================================================
// A test suite for the basic decoder

module DecodeIssueUnitL7TestSuite #(
  ...
  string suite_name = $sformatf("%0d: DecodeIssueUnitL7TestSuite_%0d_%0d_%0d_%0d_%0d_%0d_%0d", 
                                p_suite_num, p_num_pipes, p_seq_num_bits, p_num_phys_regs,
                                p_num_be_lanes, p_iq_depth, p_F_send_intv_delay, p_X_recv_intv_delay);
  ...
  `include "hw/decode_issue/test/test_cases/multi_rename_v10_test_cases.v"
...
//========================================================================
// DecodeIssueUnitL7_test
//========================================================================

module DecodeIssueUnitL7_test;
  DecodeIssueUnitL7TestSuite #(1) suite_1();
  DecodeIssueUnitL7TestSuite #(
    2, 
    2, 
    4, 
