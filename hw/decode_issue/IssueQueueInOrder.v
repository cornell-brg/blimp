...
module IssueQueueInOrder #(
  ...
  assign rt_lookup_en[0]   = bypass | !empty;
  assign rt_lookup_en[1]   = bypass | !empty;
  assign rt_lookup_areg[0] = bypass ? ins_msg_decoder_raddr0 : entries[deq_ptr[p_entry_bits-1:0]].decoder_raddr0;
  assign rt_lookup_areg[1] = bypass ? ins_msg_decoder_raddr1 : entries[deq_ptr[p_entry_bits-1:0]].decoder_raddr1;
  ...
  always_comb begin
    ...
    if( bypass ) begin
      Ex.pc               = ins_msg_pc;
      Ex.op2              = ins_msg_decoder_op2_sel ? 
      ...
      if (entries[deq_ptr[p_entry_bits-1:0]].decoder_op3_sel)
