//========================================================================
// BlimpV10_jalr_test.v
//========================================================================

`include "hw/top/test/BlimpV10TestHarness.v"

module BlimpV10TestSuite_jalr #(
...
module BlimpV10_jalr_test;
  BlimpV10TestSuite_jalr #(1)                    suite_1();
  BlimpV10TestSuite_jalr #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV10TestSuite_jalr #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV10TestSuite_jalr #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV10TestSuite_jalr #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV10TestSuite_jalr #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
