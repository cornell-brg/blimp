...
module BlimpV10_mul_test;
  BlimpV10TestSuite_mul #(1)                    suite_1();
  BlimpV10TestSuite_mul #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV10TestSuite_mul #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV10TestSuite_mul #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV10TestSuite_mul #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV10TestSuite_mul #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
