...
module BlimpV11TestSuite_fence #(
...
module BlimpV11_fence_test;
  BlimpV11TestSuite_fence #(1)                    suite_1();
  BlimpV11TestSuite_fence #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_fence #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_fence #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_fence #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_fence #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
