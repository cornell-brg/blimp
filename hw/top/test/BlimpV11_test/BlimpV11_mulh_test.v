...
module BlimpV11_mulh_test;
  BlimpV11TestSuite_mulh #(1)                    suite_1();
  BlimpV11TestSuite_mulh #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_mulh #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_mulh #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_mulh #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_mulh #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
