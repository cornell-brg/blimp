...
module BlimpV11_ori_test;
  BlimpV11TestSuite_ori #(1)                    suite_1();
  BlimpV11TestSuite_ori #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_ori #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_ori #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_ori #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_ori #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
