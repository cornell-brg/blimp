//========================================================================
// BlimpV11_xori_test.v
//========================================================================

`include "hw/top/test/BlimpV11TestHarness.v"

module BlimpV11TestSuite_xori #(
...
module BlimpV11_xori_test;
  BlimpV11TestSuite_xori #(1)                    suite_1();
  BlimpV11TestSuite_xori #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_xori #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_xori #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_xori #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_xori #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
