//========================================================================
// BlimpV11_remu_test.v
//========================================================================

`include "hw/top/test/BlimpV11TestHarness.v"

module BlimpV11TestSuite_remu #(
...
module BlimpV11_remu_test;
  BlimpV11TestSuite_remu #(1)                    suite_1();
  BlimpV11TestSuite_remu #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_remu #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_remu #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_remu #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_remu #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
