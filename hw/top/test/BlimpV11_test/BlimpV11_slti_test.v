//========================================================================
// BlimpV11_slti_test.v
//========================================================================

`include "hw/top/test/BlimpV11TestHarness.v"

module BlimpV11TestSuite_slti #(
...
module BlimpV11_slti_test;
  BlimpV11TestSuite_slti #(1)                    suite_1();
  BlimpV11TestSuite_slti #(2, 8, 5, 36, 2, 4, 1, 1) suite_2();
  BlimpV11TestSuite_slti #(3, 4, 3, 33, 2, 4, 1, 1) suite_3();
  BlimpV11TestSuite_slti #(4,32, 4, 50, 2, 4, 1, 1) suite_4();
  BlimpV11TestSuite_slti #(5, 2, 2, 48, 2, 4, 1, 3) suite_5();
  BlimpV11TestSuite_slti #(6, 4, 6, 42, 2, 4, 3, 3) suite_6();
  int s;
