...
module BlimpV9_jal_test;
  ...
  BlimpV9TestSuite_jal #(2, 8, 5, 36, 1, 1) suite_2();
  BlimpV9TestSuite_jal #(3, 4, 3, 33, 1, 1) suite_3();
  BlimpV9TestSuite_jal #(4,32, 4, 50, 3, 1) suite_4();
  BlimpV9TestSuite_jal #(5, 2, 2, 48, 1, 3) suite_5();
  BlimpV9TestSuite_jal #(6, 4, 6, 42, 3, 3) suite_6();
  int s;
