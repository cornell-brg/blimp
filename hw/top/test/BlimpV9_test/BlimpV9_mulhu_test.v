...
module BlimpV9_mulhu_test;
  ...
  BlimpV9TestSuite_mulhu #(2, 8, 5, 36, 2, 1, 1) suite_2();
  BlimpV9TestSuite_mulhu #(3, 4, 3, 33, 2, 1, 1) suite_3();
  BlimpV9TestSuite_mulhu #(4,32, 4, 50, 2, 3, 1) suite_4();
  BlimpV9TestSuite_mulhu #(5, 2, 2, 48, 2, 1, 3) suite_5();
  BlimpV9TestSuite_mulhu #(6, 4, 6, 42, 2, 3, 3) suite_6();
  int s;
