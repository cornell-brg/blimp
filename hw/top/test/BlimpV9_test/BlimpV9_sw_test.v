...
module BlimpV9_sw_test;
  BlimpV9TestSuite_sw #(1)                    suite_1();
  BlimpV9TestSuite_sw #(2, 8, 5, 36, 2, 1, 1) suite_2();
  BlimpV9TestSuite_sw #(3, 4, 3, 33, 2, 1, 1) suite_3();
  BlimpV9TestSuite_sw #(4,32, 4, 50, 2, 3, 1) suite_4();
  BlimpV9TestSuite_sw #(5, 2, 2, 48, 2, 1, 3) suite_5();
  BlimpV9TestSuite_sw #(6, 4, 6, 42, 2, 3, 3) suite_6();
  int s;
